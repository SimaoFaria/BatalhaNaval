...
var LeaderboardService = (function () {
    ...
    LeaderboardService.prototype.getLeaderboard = function () {
        ...
        return this.http.get('/api/leaderboard')
            .map(function (response) { return _this.leaderboard = response.json(); });
    };
    LeaderboardService.prototype.getTestLeaderboardVictories = function () {
        var _this = this;
        return this.http.get('/api/v1/top10victories')
            .map(function (response) { return _this.leaderboard = response.json(); });
    };
    LeaderboardService.prototype.getTestLeaderboardPoints = function () {
        var _this = this;
